...
module scale::market_tests {
    ...
    fun test_create_market(){
        ...
        assert!(market::get_officer(market) == 2,9);
    ...
    fun test_fund_fee(){
        ...
        assert!(market::get_fund_fee(market) == 3u64,8);
        ...
        assert!(market::get_fund_fee(market) == 5u64,10);
        ...
        assert!(market::get_fund_fee(market) == 7u64,12);
        ...
        assert!(market::get_fund_fee(market) == 10u64,14);
        ...
        assert!(market::get_fund_fee(market) == 20u64,16);
        ...
        assert!(market::get_fund_fee(market) == 40u64,18);
        ...
        assert!(market::get_fund_fee(market) == 70u64,20);
        ...
        assert!(market::get_fund_fee(market) == 70u64,22);
        ...
        assert!(market::get_fund_fee(market) == 70u64,24);
        // coin::destroy_for_testing(lsp_coin);
        drop_test_ctx(TestContext {
            owner,
            scenario,
