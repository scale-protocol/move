...
//     }
//     #[test]
//     fun get_test_ctx<P,T>(): TestContext<P,T> {
//         let owner = @0x1;
...
//         {
//             market::create_market_list<SCALE>(&scale_coin,test_scenario::ctx(tx));
//         };
//         test_scenario::next_tx(tx,owner);
...
//         market_id = market::create_market<P,T>(&mut list, n,i,d,1u64,800u64,object::id_from_address(@0x0),ctx);

//         test_scenario::next_tx(tx,owner);
//         // add liquidity
//         assert!(dof::exists_(market::get_list_uid_mut<P,T>(&mut list),n),1);
//         let market: &mut Market = dof::borrow_mut(market::get_list_uid_mut(&mut list),n);
//         assert!(pool::get_total_liquidity<P,T>(market::get_pool(&list)) == 0u64,4);
//         let lsp_coin = pool::add_liquidity_for_testing(market::get_pool_mut_for_testing(&mut list),coin::mint_for_testing<T>(10000,test_scenario::ctx(tx)),test_scenario::ctx(tx));
...
//     fun drop_test_ctx<P,T>(ctx: TestContext<P,T>) {
//         let TestContext {
//             owner: _,
//             scenario,
//             market_id: _,
...
//         let d = b"BTC/USD testing";
//         let i = b"https://bin.bnbstatic.com/image/admin_mgs_image_upload/20201110/87496d50-2408-43e1-ad4c-78b47b448a6a.png";
//         let new_market_id = market::create_market<P,T>(&mut list,n,i,d,1u64,800u64,object::id_from_address(@0x0),test_scenario::ctx(&mut scenario));
//         assert!(dof::exists_(market::get_list_uid_mut(&mut list),new_market_id),1);
//         let market: &mut Market = dof::borrow_mut(market::get_list_uid_mut(&mut list),new_market_id);
...
//         assert!(market::get_officer<P,T>(&list) == 2,9);
...
//     fun test_create_market_symbol_empty<P,T>(){
//         let TestContext<P,T> {
//             owner,
//             scenario,
//             market_id,
...
//         let d = b"BTC/USD testing";
//         let i = b"https://bin.bnbstatic.com/image/admin_mgs_image_upload/20201110/87496d50-2408-43e1-ad4c-78b47b448a6a.png";
//         market::create_market(&mut list,n,i,d,1u64,800u64,object::id_from_address(@0x0),test_scenario::ctx(&mut scenario));
//         drop_test_ctx(TestContext {
//             owner,
//             scenario,
//             market_id,
...
//     fun test_create_market_symbol_len<P,T>(){
//         let TestContext<P,T> {
//             owner,
//             scenario,
//             market_id,
...
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 0u64,3);
...
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 0u64,5);
//         assert!(pool::get_total_liquidity<P,T>(market::get_pool(&list)) == 10000u64,4);
//         market::set_long_position_total_for_testing(market,100u64);
//         assert!(market::get_exposure(market) == 100u64,6);
//         market::set_short_position_total_for_testing(market,900u64);
//         assert!(market::get_exposure(market) == 800u64,7);
//         // rate = 800/10000 = 0.08 so fund_fee = 3/10000 = 0.0003
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 3u64,8);
//         market::set_long_position_total_for_testing(market,6500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 1500u64,9);
//         // rate = 1500/10000 = 0.15 so fund_fee = 5/10000 = 0.0005
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 5u64,10);
//         market::set_long_position_total_for_testing(market,5500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 2500u64,11);
//         // rate = 2500/10000 = 0.25 so fund_fee = 7/10000 = 0.0007
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 7u64,12);
//         market::set_long_position_total_for_testing(market,4500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 3500u64,13);
//         // rate = 3500/10000 = 0.35 so fund_fee = 1/1000 = 0.001
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 10u64,14);
//         market::set_long_position_total_for_testing(market,3500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 4500u64,15);
//         // rate = 4500/10000 = 0.45 so fund_fee = 2/1000 = 0.002
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 20u64,16);
//         market::set_long_position_total_for_testing(market,2500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 5500u64,17);
//         // rate = 5500/10000 = 0.55 so fund_fee = 4/1000 = 0.004
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 40u64,18);
//         market::set_long_position_total_for_testing(market,1500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 6500u64,19);
//         // rate = 6500/10000 = 0.65 so fund_fee = 7/1000 = 0.007
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 70u64,20);
//         market::set_long_position_total_for_testing(market,500u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 7500u64,21);
//         // rate = 7500/10000 = 0.75 so fund_fee = 7/1000 = 0.007
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 70u64,22);
//         market::set_long_position_total_for_testing(market,0u64);
//         market::set_short_position_total_for_testing(market,8000u64);
//         assert!(market::get_exposure(market) == 8000u64,23);
//         // rate = 8000/10000 = 0.8 so fund_fee = 7/1000 = 0.007
//         assert!(market::get_fund_fee(market,pool::get_total_liquidity<P,T>(market::get_pool(&list))) == 70u64,24);
